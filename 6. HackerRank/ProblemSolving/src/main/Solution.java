...
public class Solution {
    ...
    private static int[][] getAliceAndScores() {
        File alice = new File(System.getProperty("user.dir") + "\\Problems\\src\\challenges\\alice.txt");
        File scores = new File(System.getProperty("user.dir") + "\\Problems\\src\\challenges\\scores.txt");
