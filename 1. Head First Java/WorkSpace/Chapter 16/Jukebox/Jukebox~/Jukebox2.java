...
public class Jukebox2{
	...
	public void addSongs(String song){
		...
		Integer value = Integer.parseInt(line[4]);
		Song newSong = new Song(line[0],line[1],line[2],line[3],value);
		System.out.println("New Song  - "+newSong.getTitle().hashCode()+" - "+newSong.getArtist().hashCode()+" - "+newSong.getRating().hashCode()+" - "+newSong.getBpm().hashCode()+" - "+newSong.getOrder().hashCode());
